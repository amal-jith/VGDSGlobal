...
// FAQ Expand/Collapse + Pagination
document.addEventListener("DOMContentLoaded", function () {
    const loadMoreBtn = document.getElementById("load-more");
    const faqContainer = document.getElementById("faq-container");
    const faqWrapper = document.getElementById("faqWrapper");

    if (!loadMoreBtn || !faqContainer || !faqWrapper) return;

    let originalContent = faqContainer.innerHTML;
    let isExpanded = false;

    loadMoreBtn.addEventListener("click", function () {
        let page = parseInt(loadMoreBtn.getAttribute("data-page")) || 2;
        let pageType = loadMoreBtn.getAttribute("data-page-type") || "home";

        if (!isExpanded) {
            fetch(`/faq-list/?page=${page}&type=${pageType}`)
...
document.addEventListener("DOMContentLoaded", function () {
  if (window.innerWidth <= 768) return; // ❌ Skip observer for mobile
...
////WHY US SECTION TAB CHANGES///https://lottie.host/1867c80c-d466-4275-a239-aeac3a304613/rVwe6OIRjV.lottie
 const lottieMap = {
    'flush-collapseOne': 'https://lottie.host/1867c80c-d466-4275-a239-aeac3a304613/rVwe6OIRjV.lottie', // Save Time
    ...
    'flush-collapseFive': 'https://lottie.host/ecc5057f-d7f7-4469-a206-9a15ef2f5d1b/mtuqjS5ncv.lottie'  // Fast Delivery
  };
